...
const getRuntimeConfig = (config = {}) => {
    ...
    return {
        ...
        eventStreamSerdeProvider: (_f = config.eventStreamSerdeProvider) !== null && _f !== void 0 ? _f : eventstream_serde_browser_1.eventStreamSerdeProvider,
        maxAttempts: (_g = config.maxAttempts) !== null && _g !== void 0 ? _g : middleware_retry_1.DEFAULT_MAX_ATTEMPTS,
        md5: (_h = config.md5) !== null && _h !== void 0 ? _h : md5_js_1.Md5,
        region: (_j = config.region) !== null && _j !== void 0 ? _j : invalid_dependency_1.invalidProvider("Region is missing"),
        requestHandler: (_k = config.requestHandler) !== null && _k !== void 0 ? _k : new fetch_http_handler_1.FetchHttpHandler(),
        ...
        streamHasher: (_p = config.streamHasher) !== null && _p !== void 0 ? _p : hash_blob_browser_1.blobHasher,
        utf8Decoder: (_q = config.utf8Decoder) !== null && _q !== void 0 ? _q : util_utf8_browser_1.fromUtf8,
        utf8Encoder: (_r = config.utf8Encoder) !== null && _r !== void 0 ? _r : util_utf8_browser_1.toUtf8,
    };
};
